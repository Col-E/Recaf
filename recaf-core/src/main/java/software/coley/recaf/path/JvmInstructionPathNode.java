...
/**
 * Path node for JVM instructions within {@link MethodMember} instances.
 *
 * @author Matt Coley
 */
public class JvmInstructionPathNode extends AbstractPathNode<ClassMember, AbstractInsnNode> {
	/**
	 * Type identifier for instruction nodes.
	 */
	public static final String TYPE_ID = "jvm-instruction";
	 ...
	 */
	public JvmInstructionPathNode(@Nonnull AbstractInsnNode insn, int index) {
	 ...
	 */
	public JvmInstructionPathNode(@Nullable ClassMemberPathNode parent, @Nonnull AbstractInsnNode insn, int index) {
	...
	public int localCompare(PathNode<?> o) {
		...
		if (o instanceof JvmInstructionPathNode node)
