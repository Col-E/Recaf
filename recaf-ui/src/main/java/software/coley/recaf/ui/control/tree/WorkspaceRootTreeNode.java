 ...
 * @author Matt Coley
 */
public class WorkspaceRootTreeNode extends WorkspaceTreeNode implements
		WorkspaceModificationListener, ResourceJvmClassListener, ResourceAndroidClassListener, ResourceFileListener {
