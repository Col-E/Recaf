...
/**
 * Generic outline for string table display modes.
 *
 * @author Wolfie / win32kbase
 */
public interface StringTableTableDisplayMode {
    /**
     * @param elf
     ...
     */
    void apply(ElfFile elf, ElfStringTable stringTable, SizedDataTypeTable table);
}