...
public class MediaHacker {
	 ...
	 *
	 * @param path
	 * 		URL to load, pointing to a {@link me.coley.recaf.code.FileInfo} in a {@link me.coley.recaf.workspace.Workspace}.
	 *
	 * @return Media instance with content loaded in memory.
	 */
	public static Media create(String path) throws IOException {
