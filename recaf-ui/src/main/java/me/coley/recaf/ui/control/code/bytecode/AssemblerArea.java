...
public class AssemblerArea extends SyntaxArea implements MemberEditor,
     ...
     * @param pipeline        Assembler pipeline.
     */
     ...
     *
     * @param apply {@code true} to update the {@link #getCurrentClassInfo() declaring class} with the generated field.
     ...
     *
     * @param apply {@code true} to update the {@link #getCurrentClassInfo() declaring class} with the generated method.
     * @return Generation result status.
     */
     ...
     *
     * @param updatedField Field that was compiled.
     */
     ...
     *
     * @param updatedMethod Method that was compiled.
     */
     ...
     *
     * @param updatedClass Class that was compiled.
     */
    ...
    /**
     * @param replacerProvider Function to map a class-writer to a delegated class visitor.
    ...
    /**
     * @param validator Validator that was visited.
