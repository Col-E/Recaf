...
public final class InstructionHandlerLoadArrayChar implements InstructionHandler<VarInsnNode> {
	@Override
	public void process(VarInsnNode instruction, ExecutionContext ctx) throws Throwable {
		...
		if (!(v instanceof Character)) {
			throw new InvalidBytecodeException("Attempted to load char, but value was: " + v);
		}
		ctx.push(v);
	}
}
