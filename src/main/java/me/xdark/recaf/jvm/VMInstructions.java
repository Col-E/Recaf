...
final class VMInstructions {
	...
	VMInstructions() {
		...
		// TODO GETFIELD
		// TODO PUTFIELD
		handlers[INVOKEVIRTUAL] = new InstructionHandlerInvokeVirtual();
		// TODO INVOKESPECIAL
		handlers[INVOKESTATIC] = new InstructionHandlerInvokeStatic();
	...
	InstructionHandler getHandlerForOpcode(int opcode) {
